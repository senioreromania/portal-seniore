        ...
        <section className="py-12 bg-paper border-t border-navy-deep/5">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="space-y-3 text-sm text-navy-deep/60 leading-relaxed max-w-3xl mx-auto text-left">
              <p>
                Seniore.ro este un portal care indexează <Link href="/camine" className="text-gold hover:underline font-medium">cămine de bătrâni din România</Link>, oferind familiilor informații verificate despre fiecare centru. Cauți <Link href="/camine-autorizate" className="text-gold hover:underline font-medium">cămine licențiate MMJS</Link>? Accesează lista oficială. Conform <a href="https://www.cdep.ro/ords/pls/legis/legis_pck.htp_act?ida=113748" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Legii nr. 197/2012 privind asigurarea calității serviciilor sociale</a>, centrele rezidențiale trebuie să dețină licență de funcționare emisă de <a href="https://mmuncii.gov.ro/acreditare-furnizori-si-servicii-sociale/" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Ministerul Muncii, Familiei, Tineretului și Solidarității Sociale</a>.
              </p>
              <p>
                Pentru drepturile persoanelor vârstnice, consultă <a href="https://legislatie.just.ro/Public/DetaliiDocument/21309" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Legea nr. 17/2000 privind asistența socială a persoanelor vârstnice</a>. <a href="https://caritasromania.ro/" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Confederația Caritas România</a> și <a href="https://cag.ro/" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Fundația Crucea Alb-Galbenă</a> oferă servicii de îngrijire la domiciliu. <a href="https://alz.ro/" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-medium">Societatea Română Alzheimer</a> oferă consiliere pentru familiile cu vârstnici afectați de demență.
              </p>
              <p>

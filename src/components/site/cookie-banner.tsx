...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 animate-in slide-in-from-bottom duration-300">
      <div className="bg-navy-deep text-cream mx-auto max-w-3xl m-4 rounded-xl shadow-2xl border border-gold/20">
        <div className="flex items-start gap-4 p-5">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                onClick={reject}
                className="px-5 py-2 bg-transparent text-cream/70 text-sm font-medium rounded-lg border border-cream/20 hover:border-cream/40 hover:text-cream transition-colors"
              >
